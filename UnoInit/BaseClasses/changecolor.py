...
def main_menu():
    ...
    originalbuttonBG1 = pygame.image.load("UnoInit/Buttons New/original_sign.png")

    clock = pygame.time.Clock()
    # number=0
    graph = pygame.transform.scale(originalbuttonBG1, (150, 150))
    ...
    while True:
        ...
        QUIT_BUTTON = Button(image=None, pos=(1083, 660), text_input="Qiut", font=get_font(45), base_color="#d7fcd4",
                             hovering_color="white")

        Red_BUTTON = Button(image=buttonBGred, pos=(500, 500), text_input="Red", font=get_font(15), base_color="white",
                            hovering_color="red")
        Blue_BUTTON = Button(image=buttonBGblue, pos=(600, 500), text_input="Blue", font=get_font(15),
                             base_color="white", hovering_color="blue")
        Green_BUTTON = Button(image=buttonBGgreen, pos=(700, 500), text_input="Green", font=get_font(12),
                              base_color="white", hovering_color="green")
        Yellow_BUTTON = Button(image=buttonBGyellow, pos=(800, 500), text_input="Yellow", font=get_font(12),
                               base_color="white", hovering_color="yellow")
        # change the button'position in the pos
