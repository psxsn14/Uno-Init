...
def chooselevel():
    ...
    while True:
        ...
        MIDDLE_LEVEL = Button(image=None, pos=(480, 360),
                              text_input="MIDDLE", font=get_font(55), base_color="White",
